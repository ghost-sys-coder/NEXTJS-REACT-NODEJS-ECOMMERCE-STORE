...
const Nav = ({show}) => {
  ...
  const activeLink = inactiveLink + ' bg-highlight text-black rounded-l-lg';
  ...
  return (
    <aside className={(show ? 'left-0' : '-left-full') + ' top-0 text-gray p-4 pr-0 fixed w-full h-full bg-bgGray -left-full md:static md:w-auto transition-all'}>
        <div className="mb-4">
